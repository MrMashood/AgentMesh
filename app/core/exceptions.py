...
class ConfigurationError(AgentMeshException):
    ...
    def __init__(self, message: str, missing_key: Optional[str] = None, **kwargs):
        ...
        super().__init__(
            ...
            context=context,
            recoverable=False  # Config errors usually need manual fix
        )
...
class ToolException(AgentMeshException):
    ...
    def __init__(self, tool_name: str, message: str, **kwargs):
        ...
        super().__init__(
            message=message,
            error_code=f"TOOL_{kwargs.get('error_code', 'ERROR')}",
            context=context,
...
class RateLimitError(ToolException):
    ...
    def __init__(self, tool_name: str, retry_after: Optional[int] = None, **kwargs):
...
class InvalidURLError(ToolException):
    ...
    def __init__(self, url: str, reason: str = "Invalid or blocked URL", **kwargs):
        super().__init__(
            tool_name="url_fetch",
...
class DomainNotAllowedError(InvalidURLError):
    ...
    def __init__(self, url: str, domain: str, **kwargs):
        super().__init__(
            url=url,
...
class VerificationError(AgentException):
    ...
    def __init__(self, reason: str, claims_checked: int = 0, **kwargs):
        super().__init__(
            agent_name="verification",
            message=f"Verification failed: {reason}",
            error_code="VERIFICATION_FAILED",
            context={'reason': reason, 'claims_checked': claims_checked},
            **kwargs
        )
...
class MemoryException(AgentMeshException):
    ...
    def __init__(self, message: str, memory_type: str, **kwargs):
        context = kwargs.get('context', {})
        context['memory_type'] = memory_type
        super().__init__(
            message=message,
            error_code=f"MEMORY_{kwargs.get('error_code', 'ERROR')}",
            context=context,
            recoverable=kwargs.get('recoverable', True)
        )
...
class MemoryStorageError(MemoryException):
    ...
    def __init__(self, memory_type: str, operation: str, reason: str, **kwargs):
        super().__init__(
...
class MemoryRetrievalError(MemoryException):
    ...
    def __init__(self, memory_type: str, query: str, reason: str, **kwargs):
        super().__init__(
...
class LLMException(AgentMeshException):
    ...
    def __init__(self, message: str, provider: str, **kwargs):
        ...
        super().__init__(
            message=message,
            error_code=f"LLM_{kwargs.get('error_code', 'ERROR')}",
            context=context,
            recoverable=kwargs.get('recoverable', True)
        )
...
class LLMConnectionError(LLMException):
    ...
    def __init__(self, provider: str, url: str, **kwargs):
        super().__init__(
...
class OrchestrationException(AgentMeshException):
    ...
    def __init__(self, message: str, **kwargs):
        super().__init__(
            message=message,
            error_code=f"ORCHESTRATION_{kwargs.get('error_code', 'ERROR')}",
            context=kwargs.get('context', {}),
            recoverable=kwargs.get('recoverable', True)
        )
...
class MaxRetriesExceeded(OrchestrationException):
    ...
    def __init__(self, operation: str, max_retries: int, **kwargs):
        super().__init__(
            ...
            context={'operation': operation, 'max_retries': max_retries},
            recoverable=False,
            **kwargs
        )
...
class QueryTimeoutError(OrchestrationException):
    ...
    def __init__(self, query_id: str, timeout_seconds: int, **kwargs):
        super().__init__(
            message=f"Query {query_id} timed out after {timeout_seconds} seconds",
            error_code="QUERY_TIMEOUT",
            context={'query_id': query_id, 'timeout_seconds': timeout_seconds},
            recoverable=False,
            **kwargs
        )
...
class InvalidStateError(OrchestrationException):
    ...
    def __init__(self, current_state: str, expected_state: str, **kwargs):
        super().__init__(
...
class InvalidParameterError(ValidationException):
    ...
    def __init__(self, param_name: str, param_value: Any, reason: str, **kwargs):
        super().__init__(
